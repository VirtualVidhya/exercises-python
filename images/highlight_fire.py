...
DEFAULT_FILE = 'images/greenland_fire.png'

def findFlames(filename):
    """
    ...
    for pixel in image:
        ...
        if pixel.red >= avg:
            # Mark fire: full red, no green/blue
            pixel.red = 255
            pixel.green = 0
            pixel.blue = 0
        else:
            # Grayscale non-fire areas
            pixel.red = avg
            pixel.green = avg
            pixel.blue = avg
...
def main():
    ...
    highlighted_fire = findFlames(filename)
